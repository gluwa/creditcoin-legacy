...
class Validator(object):
    def __init__(self,
        ...
        # This BlockCache is used in the ChainController and BlockValidator.
        # The keep_time for this BlockCache is set higher than the keep_time
        # of the BlockCache used in the Completer.
        #
        # Before this change, parent blocks were dropped in this BlockCache
        # before they were dropped in the Completer, leading to a race condition
        # where validation fails because of a missing predecessor.
        block_cache = BlockCache(
            block_store, keep_time=1400, purge_frequency=30)
